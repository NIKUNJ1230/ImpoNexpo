...
const GroupInvitation=({show, onHide})=>{
    return <Modal
        show={show}
        size="lg"
    >
        <Modal.Header className="justify-content-center">
            <Modal.Title className="text-center">
                GroupImport Invitation
            </Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <Row>
                <Col className="fs-5">
                    I am Inviting you or @ImponexpoBuyer is inviting you to join the GropImport of this great product
                </Col>
