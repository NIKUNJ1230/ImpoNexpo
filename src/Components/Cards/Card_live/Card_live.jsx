  ...
  return (
    <div className="card_live__component_wrap">
      <div className="card_live__component_header">
        <Link to="#" className="card_live__component_hdrleft">
          <div className="card_live__component_hlimgwrap">
            <img
              ...
              className="card_live__component_hlimg"
            />
          </div>
          <div className="card_live__component_hlcontent">
            <div className="card_live__component_hlcname">
              David Semilons
              <Flag
                code="NG"
                fallback={<span>{""}</span>}
            ...
            <div className="card_live__component_hlchandle">@davidsem22</div>
          </div>
        </Link>
        <div className="card_live__component_hdrcenter"></div>
        <div className="card_live__component_hdrright">
          <div className="card_live__component_hrfollowbtn">
            <PersonAddIcon className="card_live__component_hrfollowbtnicn" />
            <span className="card_live__component_hrfollowbtntxt">Follow</span>
          </div>
          <div className="card_live__component_hrfollowcount">120 followers</div>
        </div>
      </div>
      ...
      <div className="card_live__component_tags">
        <div className="card_live__component_tag">#go</div>
        <div className="card_live__component_tag">#World</div>
        <div className="card_live__component_tag">#David</div>
        <div className="card_live__component_tag">#Semllons</div>
        <div className="card_live__component_tag">#Export</div>
      </div>
      <div className="card_live__component_desc">
        Lorem ipsum dolor sit amet consectetur.
        <Link to="#" className="card_live__component_descreadmore">
          Read More.
        </Link>
        .
      </div>
      <div className="card_live__component_pricesec">
