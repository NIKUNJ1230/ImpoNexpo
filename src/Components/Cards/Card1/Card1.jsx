...
import test from "../../../assets/images/importer-2.svg"
...
const Card1 = ({ ProductId, ProductName, ProductDescription, ProductImage, Like, Comment, Share, Saved, StartPrice, EndPrice, MinOrder, HashTags }) => {
  ...
  return (
    <div className="card1__component_wrap">
      ...
      <div className="card1__component_stats">
        <div className="card1__component_statitem" onClick={LikeProduct}>
          ...
          <div className="card1__component_statitemtext">{likeCount}</div>
        </div>
        <div className="card1__component_statitem" onClick={toggleComment}>
          ...
          <div className="card1__component_statitemtext">{commentCount}</div>
        </div>
        ...
        >
          <div className="card1__component_statitem">
            ...
            {/* <FavoriteIcon className="card1__component_statitemicon" /> */}
            <div className="card1__component_statitemtext">{Share}</div>
          </div>
        </RWebShare>

        <div className="card1__component_statitem" onClick={SaveProduct}>
          <img
            src={Download}
            alt=""
          ...
          />
          {/* <FavoriteIcon className="card1__component_statitemicon" /> */}
          <div className="card1__component_statitemtext">{savedCount}</div>
        </div>
      </div>
      ...
      <div className="card1__component_tags">
        {HashTags.length > 0 ? (
          HashTags.map(hash => (
            <div className="card1__component_tag">{hash}</div>
          ))) : null}
      ...
      <div className="card1__component_pricesec">
        <div className="card1__component_priceleft">${StartPrice}- ${EndPrice}</div>
        <div className="card1__component_priceright">Min orders: {MinOrder} Units</div>
      </div>
