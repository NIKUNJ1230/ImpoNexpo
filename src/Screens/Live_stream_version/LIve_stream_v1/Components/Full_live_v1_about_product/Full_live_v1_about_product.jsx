...
function Full_live_v1_about_product({ isVisible, color }) {
    return isVisible && (
        <div className="full-live-v1-about-product">
            <div className="full-live-v1-about-product-title">
                <h2>About Product</h2>
            </div>
            <div className="full-live-v1-about-product-details">
                <div className="row">

                    <div className="w-4">
                        <div className="full-live-v1-about-product-details-title">
                            <h3>1. Price</h3>
                            <div className="row">
                                <div className="w-2">
                    ...
                    <div className="w-4">
                        <div className="full-live-v1-about-product-details-title">
                            <h3>2. Color</h3>
                            <div className="full-live-v1-about-product-details-title-img">
                                <img src={color} alt="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-4">
                        ...
                        <div className="full-live-v1-about-product-details-title">
                            ...
                            <div className='full-live-v1-about-product-total'>
                                <div className="row">
                                    <div className="w-2">
                                        <h2>Grand Total:</h2>
                                    </div>
                                ...
                                <Link to="live_stream_v1" className='full-live-v1-about-product-group-import'>Group Import it!</Link>
                            </div>
                        </div>
                ...
                <div className="full-live-v1-about-product-order-now">
