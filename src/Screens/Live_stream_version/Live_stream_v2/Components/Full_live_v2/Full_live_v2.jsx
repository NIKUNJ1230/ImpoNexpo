...
import "./Full_live_v2.css"
import video from "../../../../../assets/videos/test.mp4"
import Full_live_v_chat from '../../../Components/Full_live_v_chat/Full_live_v_chat';
import Full_live_v2_video from '../Full_live_v2_video/Full_live_v2_video';
import Full_live_v2_about_product from '../Full_live_v2_about_product/Full_live_v2_about_product'
...
function Full_live_v2({ isVisible }) {

    return (
        <div>
            <div className="full-live-v2">
                <div className="row">
                    <Full_live_v_chat/>
                    <Full_live_v2_video isVisible={isVisible} video={video} />
                    <Full_live_v2_about_product isVisible={isVisible} color={color}/>
                </div>
