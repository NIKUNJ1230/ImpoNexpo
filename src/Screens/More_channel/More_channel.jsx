...
function More_channel() {
  ...
  return (
    <div className="more-channel">
      ...
      <Navbar />
      <Trending
        title1={"Trending Products"}
        title2={"ImpoNexpo Channel"}
        text={"Explore great Products from great Suppliers"}
      />
      <Trending
        title1={"New Arrival on"}
        title2={"ImpoNexpo Channel"}
        text={""}
      />
      <Trending
        title1={"Your Interaction on"}
        title2={"ImpoNexpo Channel"}
        text={""}
      />
      <Expoters />
      ...
      <Trending
        title1={"On-going Group-Import"}
        title2={"ImpoNexpo Channel"}
        text={""}
      />
      <Product_cat />
      <Trending
        title1={"Categories for OEM and ODM"}
        title2={"ImpoNexpo Channel"}
        text={""}
      />
      <Footer />
